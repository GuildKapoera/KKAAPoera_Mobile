        ...
        documentReference.get()
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if (documentSnapshot.exists()) {
                            ...
                            if (name != null && vocation != null && sex != null) {
                                ...
                                Toast.makeText(CompraEVendaActivity.this, "Erro ao exibir informações. Tente novamente.", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(CompraEVendaActivity.this, LoginActivity.class));
                                finish();
                            }
                        } else {
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(CompraEVendaActivity.this, "Erro ao obter informações. Tente novamente.", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(CompraEVendaActivity.this, LoginActivity.class));
                        finish();
                    }
                });
