...
public class QueroPTActivity extends AppCompatActivity {
        ...
        documentReference.get()
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if (documentSnapshot.exists()) {
                            ...
                            if (name != null && vocation != null && sex != null) {
                                ...
                                Toast.makeText(QueroPTActivity.this, "Erro ao exibir informações. Tente novamente.", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(QueroPTActivity.this, LoginActivity.class));
                                finish();
                            }
                        } else {
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(QueroPTActivity.this, "Erro ao obter informações. Tente novamente.", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(QueroPTActivity.this, LoginActivity.class));
                        finish();
                    }
                });
    ...
    public void abrirQueroPTMinhasPTs(View view) {
        Intent intent = new Intent(this, QueroPTListaMinhasPTsActivity.class);
        startActivity(intent);
    }
